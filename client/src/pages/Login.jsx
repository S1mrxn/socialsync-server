      ...
      <nav className="bg-primary border-b border-gray-600">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/signup" className="text-white hover:text-secondary">Create account</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full relative">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white">Welcome back — please log in to continue</p>
          </div>
          ...
          <div className="bg-primary/50 rounded-xl shadow-lg p-8 mb-6 border border-gray-700">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="pl-10 w-full px-4 py-2 bg-primary/30 border border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-secondary text-sm text-white"
                  required
                />
              </div>
            ...
            <div className="relative mt-6">
              ...
              <span className="relative flex justify-center px-2 bg-primary text-gray-500 text-sm">Or continue with</span>
            </div>
