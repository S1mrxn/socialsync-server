          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-primary border border-gray-800 p-8 rounded-xl">
                ...
                <p className="text-gray-300">Join communities based on your interests and connect with like-minded people.</p>
              </div>
              <div className="bg-primary border border-gray-800 p-8 rounded-xl">
                <i className="ri-shield-check-line text-4xl text-secondary mb-4"></i>
                <h3 className="text-xl font-semibold text-white mb-2">Privacy First</h3>
                <p className="text-gray-300">Control who sees your content and how you interact.</p>
              </div>
              <div className="bg-primary border border-gray-800 p-8 rounded-xl">
                ...
                <p className="text-gray-300">Focus on meaningful interactions without the noise.</p>
              </div>
            </div>
          </div>
        </section>
