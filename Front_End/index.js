...
/* Dark theme */
        ...
        tailwind.config = {
            ...
            plugins: [],
              ...
              <body class="h-full text-base-content">
                <div id="landing-page" class="min-h-screen bg-[#0a1123]">
  <header id="header" class="fixed top-0 left-0 right-0 bg-[#0a1123] border-b border-neutral-800 z-50">
    <div class="flex justify-between items-center px-4 h-14">
      ...
      <button class="text-sm text-[#ffffff]">Log In</button>
    </div>
  </header>

  <main id="main-content" class="pt-14">
    <section id="hero" class="h-[600px] flex flex-col items-center justify-center px-6 text-center">
      <div class="mb-8">
        <i class="fa-solid fa-share-nodes text-6xl text-[#8387c3]"></i>
      </div>
      <h2 class="text-3xl mb-4 text-[#8387c3]">Share Your Story With The World</h2>
      <p class="text-[#ffffff] mb-8">Connect with friends, share moments, and discover amazing content from around the globe.</p>
      <div class="space-y-4 w-full max-w-sm">
        <button class="w-full bg-[#ba2c94] text-white py-3 rounded-lg">Create Account</button>
        <div class="flex items-center gap-4">
          <div class="h-px bg-neutral-800 flex-1"></div>
          <span class="text-[#ffffff] text-sm">or continue with</span>
          <div class="h-px bg-neutral-800 flex-1"></div>
        </div>
        <div class="grid grid-cols-3 gap-4">
          <button class="flex items-center justify-center py-3 border border-neutral-800 rounded-lg bg-[#ba2c94]">
    ...
    <section id="features" class="py-12 px-6 bg-[#0a1123] border-y border-neutral-800">
      <h3 class="text-2xl mb-8 text-center text-[#8387c3]">Why Choose SocialApp?</h3>
      <div class="space-y-8">
        <div class="flex items-start gap-4">
          <div class="w-12 h-12 flex items-center justify-center bg-[#ba2c94] rounded-full">
            <i class="fa-solid fa-users text-xl text-white"></i>
          </div>
          <div>
            <h4 class="mb-2 text-[#8387c3]">Connect with Friends</h4>
            <p class="text-[#ffffff]">Follow friends and family to stay updated with their latest posts</p>
          </div>
        </div>
        <div class="flex items-start gap-4">
          <div class="w-12 h-12 flex items-center justify-center bg-[#ba2c94] rounded-full">
          ...
          <div>
            <h4 class="mb-2 text-[#8387c3]">Share Moments</h4>
            <p class="text-[#ffffff]">Post photos and stories to capture your favorite memories</p>
          </div>
        </div>
        <div class="flex items-start gap-4">
          <div class="w-12 h-12 flex items-center justify-center bg-[#ba2c94] rounded-full">
            <i class="fa-solid fa-hashtag text-xl text-white"></i>
          </div>
          <div>
            <h4 class="mb-2 text-[#8387c3]">Discover Content</h4>
            <p class="text-[#ffffff]">Find posts and creators based on your interests</p>
          </div>
        </div>
      </div>
    </section>
  ...
  <footer id="footer" class="py-6 px-4 bg-[#0a1123] border-t border-neutral-800">
    <div class="text-center text-sm text-[#ffffff]">
      <p>© 2025 SocialApp. All rights reserved.</p>
      <div class="flex justify-center gap-4 mt-4">
        <span class="hover:text-[#8387c3] cursor-pointer">Terms</span>
        <span class="hover:text-[#8387c3] cursor-pointer">Privacy</span>
        <span class="hover:text-[#8387c3] cursor-pointer">Help</span>
      </div>
    </div>
  </footer>
</div>
