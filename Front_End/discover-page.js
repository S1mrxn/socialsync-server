...
/* Dark theme */
  ...
  <header id="header" class="fixed top-0 left-0 right-0 bg-[#0a1123] border-b border-neutral-800 z-50">
    <div class="flex justify-between items-center px-4 h-14">
      <h1 class="text-xl text-[#8fd1bf]">Discover</h1>
    </div>
  </header>

  <main id="main-content" class="pt-14 pb-16">
    <div id="search-section" class="p-4 sticky top-14 bg-[#0a1123] border-b border-neutral-800">
      <div class="relative">
        <i class="fa-solid fa-search absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400"></i>
        <input type="search" placeholder="Search posts by tags..." class="w-full pl-10 pr-4 py-2 bg-[#ffffff] rounded-lg border border-neutral-800 focus:outline-none focus:border-[#dd46b5]" />
      </div>
      <div class="flex gap-2 mt-3 overflow-x-auto pb-2">
        <button class="px-4 py-1 bg-[#dd46b5] rounded-full text-sm whitespace-nowrap text-white">#photography</button>
        <button class="px-4 py-1 bg-[#dd46b5] rounded-full text-sm whitespace-nowrap text-white">#travel</button>
        <button class="px-4 py-1 bg-[#dd46b5] rounded-full text-sm whitespace-nowrap text-white">#food</button>
        <button class="px-4 py-1 bg-[#dd46b5] rounded-full text-sm whitespace-nowrap text-white">#art</button>
        <button class="px-4 py-1 bg-[#dd46b5] rounded-full text-sm whitespace-nowrap text-white">#nature</button>
      </div>
    </div>

    <div id="grid-posts" class="grid grid-cols-3 gap-1 p-1">
      <div class="aspect-square bg-neutral-800 relative">
        <span class="absolute top-2 right-2">
          <i class="fa-solid fa-image text-[#8fd1bf]"></i>
        </span>
      </div>
      <div class="aspect-square bg-neutral-800 relative">
        <span class="absolute top-2 right-2">
          <i class="fa-solid fa-video text-[#8fd1bf]"></i>
        </span>
      </div>
      <div class="aspect-square bg-neutral-800 relative">
        <span class="absolute top-2 right-2">
          <i class="fa-solid fa-images text-[#8fd1bf]"></i>
        </span>
      </div>
  ...
  <nav id="bottom-nav" class="fixed bottom-0 left-0 right-0 bg-[#0a1123] border-t border-neutral-800">
    <div class="flex justify-around items-center h-16">
      <button class="p-2">
        <i class="fa-regular fa-house text-xl text-[#dd46b5]"></i>
      </button>
      <button class="p-2">
        <i class="fa-solid fa-search text-xl text-[#dd46b5]"></i>
      </button>
      <button class="p-2">
        <i class="fa-regular fa-plus-square text-xl text-[#dd46b5]"></i>
      </button>
      <button class="p-2">
        <i class="fa-regular fa-heart text-xl text-[#dd46b5]"></i>
      </button>
      <button class="p-2">
