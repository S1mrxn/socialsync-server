...
/* Dark theme */
  ...
  <header id="header" class="fixed top-0 left-0 right-0 bg-[#0a1123] border-b border-neutral-700 z-50">
    <div class="flex items-center px-4 h-14">
      <h1 class="text-xl text-[#8387c3]">Notifications</h1>
    </div>
  </header>

  <main id="main-content" class="pt-14 pb-16">
    <div id="notifications-tabs" class="flex border-b border-neutral-700">
      <button class="flex-1 py-3 text-center border-b-2 border-[#ba2c94] text-[#8387c3]">All</button>
      <button class="flex-1 py-3 text-center text-neutral-500">Likes</button>
      <button class="flex-1 py-3 text-center text-neutral-500">Comments</button>
      <button class="flex-1 py-3 text-center text-neutral-500">Follows</button>
    </div>

    <div id="notifications-list" class="divide-y divide-neutral-700">
      <div class="p-4">
        <h2 class="text-sm text-[#8387c3] mb-2">Today</h2>
        
        <div class="space-y-4">
          <div class="flex items-center">
            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=10" class="w-12 h-12 rounded-full" />
            <div class="ml-3 flex-1">
              <p class="text-sm text-white"><span class="text-[#8387c3]">alex_photo</span> liked your post</p>
              <p class="text-xs text-neutral-500">2 hours ago</p>
            </div>
            <div class="bg-[#ba2c94] w-12 h-12 flex items-center justify-center">
              <span class="text-xs text-white">Post</span>
            </div>
          </div>

          <div class="flex items-center">
            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=11" class="w-12 h-12 rounded-full" />
            <div class="ml-3 flex-1">
              <p class="text-sm text-white"><span class="text-[#8387c3]">sarah_89</span> started following you</p>
              <p class="text-xs text-neutral-500">5 hours ago</p>
            </div>
            <button class="bg-[#ba2c94] text-white text-sm px-4 py-1.5 rounded-md">Follow</button>
          </div>
        </div>
      </div>

      <div class="p-4">
        <h2 class="text-sm text-[#8387c3] mb-2">This Week</h2>
        
        <div class="space-y-4">
          <div class="flex items-center">
            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=12" class="w-12 h-12 rounded-full" />
            <div class="ml-3 flex-1">
              <p class="text-sm text-white"><span class="text-[#8387c3]">mike_travel</span> commented: "Amazing shot! 📸"</p>
          ...
          <div class="flex items-center">
            <div class="w-12 h-12 relative">
              <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=13" class="w-8 h-8 rounded-full absolute top-0 left-0" />
              <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=14" class="w-8 h-8 rounded-full absolute bottom-0 right-0" />
            </div>
            <div class="ml-3 flex-1">
              <p class="text-sm text-white"><span class="text-[#8387c3]">emma_22</span> and <span class="text-[#8387c3]">james_p</span> liked your post</p>
              <p class="text-xs text-neutral-500">3 days ago</p>
            </div>
            <div class="bg-[#ba2c94] w-12 h-12 flex items-center justify-center">
              <span class="text-xs text-white">Post</span>
            </div>
  ...
  <nav id="bottom-nav" class="fixed bottom-0 left-0 right-0 bg-[#0a1123] border-t border-neutral-700">
    <div class="flex justify-around items-center h-16">
      ...
      <button class="p-2">
        <i class="fa-solid fa-heart text-xl text-[#ba2c94]"></i>
      </button>
      <button class="p-2">
        <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=15" class="w-6 h-6 rounded-full" />
      </button>
    </div>
  </nav>
</div>
