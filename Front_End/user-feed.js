...
/* Dark theme */
  ...
  <!-- Header -->
  <header id="header" class="fixed top-0 left-0 right-0 bg-[#0a1123] border-b border-neutral-800 z-50">
    <div class="flex justify-between items-center px-4 h-14">
      <h1 class="text-xl text-[#8387c3]">SocialApp</h1>
      <div class="flex items-center space-x-4">
        <button class="p-2 text-[#ba2c94]">
  ...
  <main id="main-content" class="pt-14 pb-16">
    <!-- Stories -->
    <div id="stories-section" class="px-4 py-3 overflow-x-auto whitespace-nowrap border-b border-neutral-800">
      <div class="inline-flex space-x-4">
        <div class="flex flex-col items-center">
          <div class="w-16 h-16 rounded-full border-2 border-[#ba2c94] p-1">
            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=1" class="w-full h-full rounded-full" />
          </div>
          <span class="text-xs mt-1 text-[#8387c3]">Your Story</span>
        </div>
        <div class="flex flex-col items-center">
          <div class="w-16 h-16 rounded-full border-2 border-neutral-400 p-1">
            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=2" class="w-full h-full rounded-full" />
          </div>
          <span class="text-xs mt-1 text-[#8387c3]">user123</span>
        </div>
        <div class="flex flex-col items-center">
          <div class="w-16 h-16 rounded-full border-2 border-neutral-400 p-1">
            <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=3" class="w-full h-full rounded-full" />
          </div>
          <span class="text-xs mt-1 text-[#8387c3]">jane_doe</span>
        </div>
      </div>
    </div>
    ...
    <div id="posts-feed" class="space-y-6">
      <!-- Post 1 -->
      <article class="bg-[#0a1123] border-b border-neutral-800">
        <div class="flex items-center p-4">
          <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=4" class="w-8 h-8 rounded-full" />
          <div class="ml-3">
            <p class="text-[#8387c3]">john_smith</p>
            <p class="text-xs text-[#8387c3]/70">New York, NY</p>
          </div>
          <button class="ml-auto text-[#ba2c94]">
            <i class="fa-solid fa-ellipsis"></i>
          </button>
        </div>
        <div class="bg-neutral-300 h-[400px] flex items-center justify-center text-white">
          <span>Post Image</span>
        </div>
        <div class="p-4">
          <div class="flex items-center space-x-4">
            <button class="text-[#ba2c94]"><i class="fa-regular fa-heart text-2xl"></i></button>
            <button class="text-[#ba2c94]"><i class="fa-regular fa-comment text-2xl"></i></button>
            <button class="text-[#ba2c94]"><i class="fa-regular fa-paper-plane text-2xl"></i></button>
            <button class="ml-auto text-[#ba2c94]"><i class="fa-regular fa-bookmark text-2xl"></i></button>
          </div>
          <p class="mt-2 text-white">1,234 likes</p>
          <p class="mt-1 text-[#8387c3]"><span>john_smith</span> Beautiful sunset view! 🌅 #nature #photography</p>
          <p class="text-[#8387c3]/70 text-sm mt-1">View all 48 comments</p>
          <p class="text-[#8387c3]/50 text-xs mt-1">2 HOURS AGO</p>
        </div>
      </article>
      ...
      <article class="bg-[#0a1123] border-b border-neutral-800">
        <div class="flex items-center p-4">
          <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=5" class="w-8 h-8 rounded-full" />
          <div class="ml-3">
            <p class="text-[#8387c3]">travel_lover</p>
            <p class="text-xs text-[#8387c3]/70">Paris, France</p>
          </div>
          <button class="ml-auto text-[#ba2c94]">
            <i class="fa-solid fa-ellipsis"></i>
          </button>
        ...
        <div class="p-4">
          ...
          <p class="mt-2 text-white">2,567 likes</p>
          <p class="mt-1 text-[#8387c3]"><span>travel_lover</span> Exploring the streets of Paris! 🗼 #travel #france</p>
          <p class="text-[#8387c3]/70 text-sm mt-1">View all 92 comments</p>
          <p class="text-[#8387c3]/50 text-xs mt-1">5 HOURS AGO</p>
        </div>
      </article>
    </div>
  </main>
  ...
  <!-- Bottom Navigation -->
  <nav id="bottom-nav" class="fixed bottom-0 left-0 right-0 bg-[#0a1123] border-t border-neutral-800">
    <div class="flex justify-around items-center h-16">
      ...
      <button class="p-2">
        <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=6" class="w-6 h-6 rounded-full" />
      </button>
    </div>
  </nav>

  <!-- Music Player -->
  <div id="music-player" class="fixed bottom-20 right-4 bg-[#0a1123] border border-[#ba2c94] rounded-lg p-3 shadow-lg">
    <div class="flex items-center space-x-3">
      <div class="flex flex-col">
        <span class="text-[#8387c3] text-xs">Now Playing</span>
        <span class="text-[#8387c3]/70 text-xs">Lofi Beats</span>
      </div>
      <div class="flex items-center space-x-2">
        <button class="text-[#ba2c94]">
