...
/* Dark theme */
  ...
  <header id="header" class="fixed top-0 left-0 right-0 bg-[#0a1123] border-b border-neutral-700 z-50">
    <div class="flex justify-between items-center px-4 h-14">
      <button class="text-[#8387c3]">
        <i class="fa-solid fa-arrow-left text-xl"></i>
      </button>
      <h1 class="text-[#8387c3] text-lg">New Post</h1>
      <button class="text-[#ba2c94]">Share</button>
    </div>
  </header>

  <main id="create-post" class="pt-14 pb-16">
    <div id="post-content" class="bg-[#0a1123]">
      <div class="flex p-4 items-center border-b border-neutral-700">
        <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=123" class="w-8 h-8 rounded-full" />
        <span class="ml-3 text-[#8387c3]">username</span>
      </div>

      <div id="image-upload" class="relative">
        <div class="bg-neutral-900 h-[400px] flex flex-col items-center justify-center">
          <i class="fa-regular fa-image text-4xl text-neutral-400 mb-4"></i>
          <button class="bg-[#ba2c94] text-white px-6 py-2 rounded-lg">Add Photos/Videos</button>
        </div>
      </div>

      <div id="post-details" class="p-4">
        <textarea placeholder="Write a caption..." class="w-full h-24 resize-none border-0 focus:ring-0 bg-[#0a1123] text-[#ffffff] placeholder-neutral-500"></textarea>
        
        <div class="border-t border-neutral-700 pt-4">
          <button class="flex items-center justify-between w-full py-2">
            <span class="text-[#8387c3]">Add location</span>
            <i class="fa-solid fa-location-dot text-[#ba2c94]"></i>
          </button>
          
          <button class="flex items-center justify-between w-full py-2">
            <span class="text-[#8387c3]">Tag people</span>
            <i class="fa-regular fa-user text-[#ba2c94]"></i>
          </button>

          <div class="flex items-center justify-between w-full py-2">
            <span class="text-[#8387c3]">Add hashtags</span>
            <i class="fa-solid fa-hashtag text-[#ba2c94]"></i>
          </div>
        </div>

        <div class="mt-4">
          <input type="text" placeholder="Add hashtags (separated by spaces)" class="w-full px-3 py-2 border border-neutral-700 rounded-lg focus:outline-none focus:border-[#8387c3] bg-[#0a1123] text-[#ffffff] placeholder-neutral-500" />
        </div>

        <div class="flex items-center mt-4 pt-4 border-t border-neutral-700">
          <button class="flex items-center space-x-2">
            <i class="fa-solid fa-earth-americas text-[#ba2c94]"></i>
            <span class="text-[#8387c3]">Everyone can reply</span>
          </button>
          <i class="fa-solid fa-chevron-right text-[#ba2c94] ml-auto"></i>
        </div>
      </div>
    </div>
  </main>
  ...
  <nav id="bottom-nav" class="fixed bottom-0 left-0 right-0 bg-[#0a1123] border-t border-neutral-700">
    <div class="flex justify-around items-center h-16">
      <button class="p-2">
        <i class="fa-regular fa-image text-xl text-[#ba2c94]"></i>
      </button>
      <button class="p-2">
        <i class="fa-solid fa-camera text-xl text-[#ba2c94]"></i>
      </button>
      <button class="p-2">
        <i class="fa-regular fa-file-video text-xl text-[#ba2c94]"></i>
      </button>
    </div>
  </nav>
</div>
