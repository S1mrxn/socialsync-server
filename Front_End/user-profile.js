...
/* Dark theme */
  ...
  <header id="header" class="fixed top-0 left-0 right-0 bg-[#0a1123] border-b border-neutral-700 z-50">
    <div class="flex items-center px-4 h-14">
      ...
      <h1 class="text-xl text-[#8fd1bf]">john_smith</h1>
      <button class="ml-auto">
        <i class="fa-solid fa-ellipsis text-xl text-[#8fd1bf]"></i>
      </button>
    </div>
  </header>

  <main id="main-content" class="pt-14 pb-16">
    <div id="profile-info" class="p-4">
      <div class="flex items-start">
        <div class="w-20 h-20">
          <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=123" class="w-full h-full rounded-full border-2 border-neutral-700" />
        </div>
        <div class="flex-1 ml-8">
          <div class="grid grid-cols-3 text-center">
            <div>
              <div class="text-lg text-white">245</div>
              <div class="text-sm text-[#8fd1bf]">Posts</div>
            </div>
            <div>
              <div class="text-lg text-white">14.3K</div>
              <div class="text-sm text-[#8fd1bf]">Followers</div>
            </div>
            <div>
              <div class="text-lg text-white">892</div>
              <div class="text-sm text-[#8fd1bf]">Following</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mt-4">
        <h2 class="text-[#8fd1bf]">John Smith</h2>
        <p class="text-sm text-[#8fd1bf] mt-1">📸 Photography enthusiast</p>
        <p class="text-sm text-[#8fd1bf]">🌎 Travel lover</p>
        <p class="text-sm text-[#8fd1bf]">🗽 New York based</p>
        <p class="text-sm text-[#8fd1bf] mt-1">www.johnsmith.photo</p>
      </div>

      <div class="flex gap-2 mt-4">
        <button class="flex-1 bg-white text-[#000100] py-2 rounded-md">Edit Profile</button>
        <button class="flex-1 bg-white text-[#000100] border border-neutral-700 py-2 rounded-md">Share Profile</button>
      </div>
    </div>

    <div id="profile-tabs" class="border-t border-neutral-700 mt-4">
      <div class="grid grid-cols-3 text-center">
        <button class="py-4 border-b-2 border-[#ba2c94]">
          <i class="fa-solid fa-grid-2 text-xl text-[#ba2c94]"></i>
        </button>
        <button class="py-4 border-b border-neutral-700">
          <i class="fa-regular fa-bookmark text-xl text-[#ba2c94]"></i>
        </button>
        <button class="py-4 border-b border-neutral-700">
          <i class="fa-solid fa-user-tag text-xl text-[#ba2c94]"></i>
        </button>
      </div>
    </div>

    <div id="posts-grid" class="grid grid-cols-3 gap-[2px] bg-neutral-700">
      <div class="bg-neutral-800 aspect-square flex items-center justify-center">
        <span class="text-white">Post 1</span>
      </div>
      <div class="bg-neutral-800 aspect-square flex items-center justify-center">
        <span class="text-white">Post 2</span>
      </div>
      <div class="bg-neutral-800 aspect-square flex items-center justify-center">
        <span class="text-white">Post 3</span>
      </div>
      <div class="bg-neutral-800 aspect-square flex items-center justify-center">
        <span class="text-white">Post 4</span>
      </div>
      <div class="bg-neutral-800 aspect-square flex items-center justify-center">
        <span class="text-white">Post 5</span>
      </div>
      <div class="bg-neutral-800 aspect-square flex items-center justify-center">
        <span class="text-white">Post 6</span>
      </div>
    </div>
  </main>
  ...
  <nav id="bottom-nav" class="fixed bottom-0 left-0 right-0 bg-[#0a1123] border-t border-neutral-700">
    <div class="flex justify-around items-center h-16">
      ...
      <button class="p-2">
        <img src="https://api.dicebear.com/7.x/notionists/svg?scale=200&seed=123" class="w-6 h-6 rounded-full border-2 border-[#ba2c94]" />
      </button>
    </div>
  </nav>
</div>
